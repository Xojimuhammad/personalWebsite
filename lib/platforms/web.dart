...
class Web extends StatelessWidget {
  Web({Key? key,required this.controller,required this.list}) : super(key: key);
  List<String> list = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
              onPressed:() => scrollController.jumpTo(1350),
              child: const Text(
                "Home",
                style: TextStyle(color: Colors.black),
              )),
          Padding(
            ...
            child: TextButton(
                onPressed: () => scrollController.jumpTo(450),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 60),
            child: TextButton(
                onPressed: () => scrollController.jumpTo(1600),
